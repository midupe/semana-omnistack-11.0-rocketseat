...
export default function Incidents() {
    ...
    const message = `Olá ${incident.name}, estou a entrar em contacto pois gostava de ajudar no caso "${incident.title}" com o valor de ${Intl.NumberFormat('pt-PT', {style: 'currency', currency: 'EUR'}).format(incident.value)}.`;
